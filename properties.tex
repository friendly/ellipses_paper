\subsection{Taxonomy of ellipsoids}
\secref{sec:geometric} defined a proper origin-centered ellipsoid in  $\Real{p}$ by
...
\TODO{Georges: I'm not sure this is necessary, given what I retained in \secref{sec:geometric}.}
