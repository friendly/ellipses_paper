...
ellipsoids that are not necessarily centered at the origin.  %% added fact /GM  

In the principal-component (PC) factorization (shown dashed in brown in \figref{fig:conjugate}, right) $\mat{W}=\mat{C} \mat{C}\trans$, where
