...
similar to to \figref{fig:levdemo21}, what we call
...
\figref{fig:levdemo22} to allow direct comparison.  Since you now know that regression lines
...
point ``L'' (added in panel (c) of \figref{fig:levdemo21}) i called a ``good leverage point.''
