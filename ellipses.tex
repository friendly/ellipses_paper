...
\end{titlepage}
\maketitle
%\thispagestyle{fancy}\lhead{Submitted: \emph{Statistical Science}, 2011}\rhead{Elliptical Insights}\afterpage{\lhead{}\rhead{}}
...
\bibliography{ellipses}        % processed by bibtool -- quiet=on -r ~/texmf/bibtex/bib/aux2bib.rsc -x ellipses.aux -o ellipses.bib
}
...
A number of these can be traced to or have more general descriptions within the abstract formulation of \citet[henceforth $\mathcal{D}$]{Dempster:69},
