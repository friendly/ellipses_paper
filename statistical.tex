\subsection{Statistical ellipsoids}\label{sec:statistical}
...
One convenient choice of \mat{A} is the Choleski square root, $\mat{W}^{1/2}$, as we describe in \appref{sec:conjugate}.
